...
import com.example.abdelhaf.weather.domain.models.CountriesModel;
...
public class Controller {
    ...
    public interface Weather {
        ...
        @GET("data/2.5/group")
        Observable<WeatherModel> getGroupWeatherServices( @Query("id") String id,@Query("units") String units );
